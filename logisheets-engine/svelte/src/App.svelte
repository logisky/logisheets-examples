<script lang="ts">
    ...
    onMount(() => {
        ...
        eng.on('ready', () => {
            eng.mount(gridEl, {showSheetTabs: true, showScrollbars: true})

            const source = createEngineFormulaSource(eng.getDataService())
            bar = createFormulaEditor(formulaEl, {
                ...source,
...
<div class="layout">
    <div class="formula-bar">
        ...
        <div class="formula-editor" bind:this={formulaEl}></div>
    </div>
